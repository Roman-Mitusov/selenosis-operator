...
// K8sSeleniumHubReconciler reconciles a K8sSeleniumHub object
type K8sSeleniumHubReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *K8sSeleniumHubReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("k8sseleniumhub", req.NamespacedName)
...
func (r *K8sSeleniumHubReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&seleniumk8siov1.K8sSeleniumHub{}).
		Complete(r)
}
